...
| 8 | datatypes/datetimes.jl, times.jl, durations.jl, timezones.jl | operations/namespaces/temporal/test_datetime.py, test_offset_by.py, test_round.py, test_truncate.py, test_replace.py, datatypes/test_temporal.py, test_duration.py, test_time.py | unswept |
| 9 | datatypes/lists.jl, structs.jl, list_struct_write.jl | operations/namespaces/list/test_list.py, test_set_operations.py, test_unique.py, operations/namespaces/test_struct.py, datatypes/test_list.py, test_struct.py, operations/test_explode.py | unswept |
