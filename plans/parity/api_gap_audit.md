...
Per [`LEDGER.md`](LEDGER.md), **batches 11, 13, and 14 of the py-polars parity sweep are still
unswept** (batches 10 and 12 are now done, findings below): join/group_by/group_by_dynamic/rolling
(7 upstream files), lazyframe scan/sink/collect_schema/head (9), and
