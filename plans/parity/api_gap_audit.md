...
Per [`LEDGER.md`](LEDGER.md), **batches 11, 12, and 13 of the py-polars parity sweep are still
unswept** (batches 10 and 14 are now done, findings below): join/group_by/group_by_dynamic/rolling
(7 upstream files), series/binary/construction/io/describe (9), and lazyframe
scan/sink/collect_schema/head (9).
