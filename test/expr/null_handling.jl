...
@testset "is_in" begin
    ...
    # multi-value membership: implode(lit(::Vector)) (see test/expr/lit_vector.jl) takes the whole
    # set in one literal, with no chaining of single-value implode(lit(x))s
