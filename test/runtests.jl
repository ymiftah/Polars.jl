...
@testset "Polars.jl" begin
    ...
    include("lazyframe/scan_ndjson.jl")
    include("lazyframe/sink_ndjson.jl")
    ...
    include("expr/rolling.jl")
    include("expr/ewm.jl")
    include("expr/cut_qcut.jl")
