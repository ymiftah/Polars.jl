...
- The [Developer](@ref) page and the [Polars.jl README](https://github.com/ymiftah/Polars.jl)
  cover implementation details and build instructions for the underlying Rust `c-polars` bridge,
  useful if you want to extend the wrapper itself.
