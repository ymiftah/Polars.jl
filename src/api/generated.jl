...
function polars_lazy_frame_sink_parquet_partitioned(lf, base_path, base_pathlen, keys, n_keys, include_keys, max_rows_per_file, approximate_bytes_per_file, compression, compression_level, statistics, row_group_size, data_page_size, maintain_order, cloud_options, out)
    return @ccall libpolars.polars_lazy_frame_sink_parquet_partitioned(lf::Ptr{polars_lazy_frame_t}, base_path::Ptr{UInt8}, base_pathlen::Csize_t, keys::Ptr{Ptr{polars_expr_t}}, n_keys::Csize_t, include_keys::Bool, max_rows_per_file::Ptr{UInt64}, approximate_bytes_per_file::Ptr{UInt64}, compression::polars_parquet_compression_t, compression_level::Ptr{Int32}, statistics::Bool, row_group_size::Ptr{Csize_t}, data_page_size::Ptr{Csize_t}, maintain_order::Bool, cloud_options::Ptr{polars_cloud_options_t}, out::Ptr{Ptr{polars_lazy_frame_t}})::Ptr{polars_error_t}
end
